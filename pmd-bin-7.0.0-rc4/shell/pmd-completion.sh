...
function _picocli_pmd_check() {
  ...
  local arg_opts="--encoding -e --dir -d --file-list --uri -u --relativize-paths-with -z --format -f --rulesets -R --ignore-list --suppress-marker --minimum-priority --report-file -r --use-version --force-language --aux-classpath --cache --threads -t --property -P"
  ...
  local languageVersion_option_args=("apex-52" "apex-53" "apex-54" "apex-55" "apex-56" "apex-57" "apex-58" "apex-59" "ecmascript-3" "ecmascript-5" "ecmascript-6" "ecmascript-7" "ecmascript-8" "ecmascript-9" "ecmascript-ES2015" "ecmascript-ES2016" "ecmascript-ES2017" "ecmascript-ES2018" "ecmascript-ES6" "html-4" "html-5" "java-1.10" "java-1.3" "java-1.4" "java-1.5" "java-1.6" "java-1.7" "java-1.8" "java-1.9" "java-10" "java-11" "java-12" "java-13" "java-14" "java-15" "java-16" "java-17" "java-18" "java-19" "java-20" "java-20-preview" "java-21" "java-21-preview" "java-5" "java-6" "java-7" "java-8" "java-9" "jsp-2" "jsp-3" "kotlin-1.6" "kotlin-1.7" "kotlin-1.8" "modelica-3.4" "modelica-3.5" "plsql-11g" "plsql-12.1" "plsql-12.2" "plsql-12c_Release_1" "plsql-12c_Release_2" "plsql-18c" "plsql-19c" "plsql-21c" "pom-4.0.0" "scala-2.10" "scala-2.11" "scala-2.12" "scala-2.13" "swift-4.2" "swift-5.0" "swift-5.1" "swift-5.2" "swift-5.3" "swift-5.4" "swift-5.5" "swift-5.6" "swift-5.7" "vf-52" "vf-53" "vf-54" "vf-55" "vf-56" "vf-57" "vf-58" "vf-59" "vm-2.0" "vm-2.1" "vm-2.2" "vm-2.3" "wsdl-1.1" "wsdl-2.0" "xml-1.0" "xml-1.1" "xsl-1.0" "xsl-2.0" "xsl-3.0") # --use-version values
  ...
  local StringString_option_args=("problem" "package" "file" "priority" "line" "desc" "ruleSet" "rule" "linkPrefix" "linePrefix" "htmlExtension" "fileName" "sourcePath" "classAndMethodName" "linkPrefix" "linePrefix" "htmlExtension" "color" "encoding" "encoding" "xsltFilename" "outputDir") # --property values
...
function _picocli_pmd_cpd() {
  ...
  local commands=""
  local flag_opts="-h --help --debug --verbose -D -v --no-fail-on-violation --skip-duplicate-files --ignore-literals --ignore-identifiers --ignore-annotations --ignore-usings --ignore-literal-sequences --ignore-sequences --skip-lexical-errors --no-skip-blocks --non-recursive"
  local arg_opts="--encoding -e --dir -d --file-list --uri -u --relativize-paths-with -z --language -l --minimum-tokens --format -f --skip-blocks-pattern --exclude"
  local language_option_args=("apex" "coco" "cpp" "cs" "dart" "ecmascript" "fortran" "gherkin" "go" "groovy" "html" "java" "jsp" "julia" "kotlin" "lua" "matlab" "modelica" "objectivec" "perl" "php" "plsql" "pom" "python" "ruby" "scala" "swift" "tsql" "typescript" "vf" "vm" "wsdl" "xml" "xsl") # --language values
